...
import Mottum.Cenarios.Cenarios;
import Mottum.Utils.Tempo;
...
public class Windows extends JFrame implements Runnable {
	...
	public Mottum.Input.Mouse mMouse;
	public Mottum.Input.Teclado mTeclado;
	...
	public Windows(String eTitulo, int eLargura, int eAltura) {
		...
		mMouse = new Mottum.Input.Mouse();
		mTeclado = new Mottum.Input.Teclado();
	...
	public Mottum.Input.Mouse getMouse() {
		return mMouse;
	}

	public Mottum.Input.Teclado getTeclado() {
		return mTeclado;
	}
